...
public class RendererCommon {
  ...
  public static interface GlDrawer {
    ...
    void drawYuv(int[] yuvTextures, float[] texMatrix, int frameWidth, int frameHeight,
        int viewportX, int viewportY, int viewportWidth, int viewportHeight);
    void drawYuvNV21(int[] yuvTextures, float[] texMatrix, int frameWidth, int frameHeight,
                     int viewportX, int viewportY, int viewportWidth, int viewportHeight);
    /**
  ...
  public static class YuvUploader {
    ...
    /**
     * Upload nv21 outputYuvTextures.
     * |outputYuvTextures| must have been generated in advance.
     */
    public void uploadNV21Data(int[] outputYuvTextures, int width, int height, ByteBuffer[] planes) {
      ...
      for (int i = 0; i < 3; ++i) {
        ...
        // Input is packed already.
        GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_LUMINANCE, planeWidths[i],
                planeHeights[i], 0, GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE, planes[i]);
      }
    }
     ...
     * |outputYuvTextures| must have been generated in advance.
     */
    public void uploadNV21SPData(int[] outputYuvTextures, int width, int height, ByteBuffer[] planes) {

      // Upload each plane.
      GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
      GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, outputYuvTextures[0]);
      GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_LUMINANCE, width, height, 0, GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE, planes[0]);
      //GLES20.glUniform1i(gvImageTextureY, 0);

      GLES20.glActiveTexture(GLES20.GL_TEXTURE0+1);
      GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, outputYuvTextures[1]);
      GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_LUMINANCE_ALPHA, width/2, height/2, 0, GLES20.GL_LUMINANCE_ALPHA, GLES20.GL_UNSIGNED_BYTE, planes[1]);
      //GLES20.glUniform1i(gvImageTextureUV, 1);
    }
