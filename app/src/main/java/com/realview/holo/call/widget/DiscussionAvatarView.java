...
import com.realview.commonlibrary.util.DensityUtil;
...
public class DiscussionAvatarView extends ViewGroup {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (array != null) {
            int radius = array.getInteger(R.styleable.DiscussionAvatarView_imageRadius, 13);
    ...
    public void initDatas(ArrayList<String> list) {
        ...
        for (int i = 0; i < size; i++) {
            ImageView iv = (ImageView) mInflater.inflate(R.layout.view_avatars_item, this, false);
            if (mIsLastComplete) {
     ...
     * @param ava
     */
    public void addData(String ava, String name) {
        addData(ava, name, null);
    }
     ...
     * @param listener1
     */
    public void addData(String avatarUrl, String name, DiscussionAvatarListener listener1) {
        ...
        final View view = mInflater.inflate(R.layout.view_avatars_item, this, false);
        final ImageView imageView = view.findViewById(R.id.avatars_iv_show);
        TextView tv = view.findViewById(R.id.avatars_tv_show);
        tv.setText(TextUtils.isEmpty(name) ? "" : name);


//        final ImageView iv = (ImageView) mInflater.inflate(R.layout.view_avatars_item, this, false);
        GlideUtil.loadCircleImageView(mContext, avatarUrl, imageView, mIsShowFrame, mFrameColor);
