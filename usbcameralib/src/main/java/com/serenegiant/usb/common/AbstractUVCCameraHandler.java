...
public abstract class AbstractUVCCameraHandler extends Handler {
    ...
    public interface OnCaptureListener {
        void onCaputreResult(byte[] data);
    }
...
//	}
    ...
    public void captureStill(AbstractUVCCameraHandler.OnCaptureListener listener) {
    ...
    public void handleMessage(final Message msg) {
        ...
        switch (msg.what) {
            case MSG_OPEN:
                ...
                break;
            case MSG_CLOSE:
                Log.d(TAG, "receive close Message");
                thread.handleClose();
                break;
...
//				thread.handleCaptureStill((String)msg.obj);
                thread.handleStillPicture(true);
                break;
...
//		}
        ...
        public void handleClose() {
            Log.d(TAG_THREAD, "camera msg handleClose:");
...
//			isAudioThreadStart = false;
        ...
        private boolean mBitmap = false;

        public void handleStillPicture(boolean mBitmap) {
        ...
        private final IFrameCallback mIFrameCallback = new IFrameCallback() {
            ...
            public void onFrame(final ByteBuffer frame) {
                ...
                // 捕获图片
                if (isCaptureStill && mBitmap) {
                    if (mCaptureListener != null) {
                        mBitmap = false;
                        isCaptureStill = false;
//                        YuvImage yuvImage = new YuvImage(data, ImageFormat.NV21, UVCCameraHelper.getInstance().getPreviewWidth(), UVCCameraHelper.getInstance().getPreviewHeight(), null);
//                        ByteArrayOutputStream bos = new ByteArrayOutputStream(data.length);
                        mCaptureListener.onCaputreResult(yuv);
                    }
